    ...
    const handleSendEmail = async () => {
        try {
            ...
            const response = await axios.post(`${backendUrl}/api/Email/SendEmail`, {
                firstName: "Ayca", // Replace with the appropriate first name
                lastName: "Akbas", // Replace with the appropriate last name
                email: "upcrawler1@gmail.com", // Replace with the appropriate email address
